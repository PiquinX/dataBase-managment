...
function InfoInputs ({ placeHolder, defaultValue, onChange }) {
  return (
    <div className='relative w-64 h-10'>
      ...
      <input defaultValue={defaultValue} onChange={onChange} className='w-full h-full px-2 overflow-auto font-bold text-white bg-transparent border-2 rounded outline-none' />
    </div>
  )
}
