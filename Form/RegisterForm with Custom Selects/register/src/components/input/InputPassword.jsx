...
export function InputPassword ({ placeholder, nameId, tabIndex, exportValue, value }) {
  ...
  return (
    <div className='input-container'>
      <input placeholder={placeholder} type={type} id={nameId} name={nameId} value={value} minLength='4' maxLength='40' className='inputs' tabIndex={tabIndex[0]} onChange={exportValue} />
